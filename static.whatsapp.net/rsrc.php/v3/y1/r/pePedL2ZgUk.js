...
__d("vulture", ["ExecutionEnvironment", "FBLogger", "JSResource", "clearTimeout", "justknobx", "objectEntries", "requireDeferred", "setTimeout"], (function (a, b, c, d, e, f, g) {
    "use strict";
    var h, i = 0,
        j = -1,
        k = null;
    c("requireDeferred")("ODS").__setRef("vulture").onReadyImmediately(function (a) {
        k = a, u()
    });
    var l = !1,
        m = !1,
    ...
    function r(a) {
        ...
        b == null ? k.bumpEntityKey(7506, "vulture_js", a) : b === j ? (k.bumpEntityKey(7506, "vulture_js", a), c("FBLogger")("vulture_js", "low_volume_" + a).addToCategoryKey(a).addMetadata("VULTURE_JS", "LOW_VOLUME_HASH", a).warn("Low volume vulture with hash %s hit", a)) : Math.floor(Math.random() * b) === 0 && k.bumpEntityKey(7506, "vulture_js", a, b)
    }
    ...
    function v() {
        if (m) return;
        m = !0;
        (h || (h = c("ExecutionEnvironment"))).canUseDOM && (n = c("setTimeout")(function () {
            t(), c("FBLogger")("vulture_js", "sample_rate_load_timeout").warn("Timed out attemping to fetch VultureJS sample rates")
        }, q));
        c("JSResource")("VultureJSSampleRatesLoader").__setRef("vulture").load().then(function (a) {
            for (var a = c("objectEntries")(a.sample_rates), b = Array.isArray(a), d = 0, a = b ? a : a[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                var e;
                if (b) {
                    if (d >= a.length) break;
                    e = a[d++]
    ...
    function a(a) {
        c("justknobx")._("2635") && (l && k != null ? r(a) : (s(a), v()))
    }
    g["default"] = a
}), 98);
                    ...
                    for (f = k, e = Array.isArray(f), d = 0, f = e ? f : f[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
                        ...
                        try {
                            ...
                            if (j != null) {
                                ...
                                m != null && (a.push(b.onLoad), k["delete"](g), c("FBLogger")("CSSPoller").info("New CSS experimental poll technique was able to poll CSS"))
                            }
                        } catch (a) {
                            c("FBLogger")("CSSPoller").catching(a).warn("New CSS experimental poll technique was unable to poll CSS: %s with CORS setting %s", i.href, i.crossOrigin)
                        }
                    }
                if (!(h || (h = c("isEmpty")))(a)) {
...
__d("setTimeoutCometInternals", ["JSScheduler"], (function (a, b, c, d, e, f, g) {
    ...
    function a(a) {
        if (a != null) {
            var b = i.get(a);
            b !== void 0 && (i["delete"](a), (h || (h = c("JSScheduler"))).cancelDelayedCallback_DO_NOT_USE(b))
        }
    }
...
__d("unstable_server-external-runtime", ["Promise"], (function (a, b, c, d, e, f) {
    ...
    (function () {
        ...
        function c(c, d, e) {
            ...
            for (var i = new Map(), j = document, k, l, m = j.querySelectorAll("link[data-precedence],style[data-precedence]"), n = [], o = 0; l = m[o++];) "not all" === l.getAttribute("media") ? n.push(l) : ("LINK" === l.tagName && h.set(l.getAttribute("href"), l), i.set(l.dataset.precedence, k = l));
            l = 0;
            m = [];
            var p, q;
            for (o = !0;;) {
                if (o) {
                    ...
                    if (q = h.get(u)) {
                        ...
                        q.href = u;
                        q.rel = "stylesheet";
                        for (q.dataset.precedence = p = r[t++]; v = r[t++];) q.setAttribute(v, r[t++]);
                ...
                s === k && (k = q);
                i.set(p, q);
                s ? s.parentNode.insertBefore(q, s.nextSibling) : (s = j.head, s.insertBefore(q, s.firstChild))
        ...
        function f(b) {
            if (1 === b.nodeType && b.dataset) {
                ...
                if (null != d.rxi) {
                    ...
                    i && (d = i.previousSibling, d.data = "$!", i = i.dataset, e && (i.dgst = e), f && (i.msg = f), g && (i.stck = g), h && (i.cstck = h), d._reactRetry && d._reactRetry());
                    b.remove()
        ...
        (function () {
            addEventListener("submit", function (a) {
                if (!a.defaultPrevented) {
                    ...
                    "javascript:throw new Error('React form unexpectedly submitted.')" === d && (a.preventDefault(), e ? (a = document.createElement("input"), a.name = e.name, a.value = e.value, e.parentNode.insertBefore(a, e), e = new FormData(b), a.parentNode.removeChild(a)) : e = new FormData(b), a = b.ownerDocument || b, (a.$$reactFormReplay = a.$$reactFormReplay || []).push(b, c, e))
                }
            })
        })();
...
__d("hyperionGlobal", [], (function (a, b, c, d, e, f) {
    e = typeof globalThis === "object" ? globalThis : typeof a === "object" ? a : typeof window === "object" ? window : typeof self === "object" ? self : {};
    var g = {
